<template lang="">
  <div class="page-panel mood-panel">
    ...
    <div class="mood-groups">
      <div class="mood-group" style="--i: (0)" :class="{ active: activeMood == 0 }" @click="setActiveMood(0)" @mouseover="hoverMood('cool-duck')">
        <img class="mood-duck-img" src="../../assets/images/ducks/cool-duck.png" alt="cool duck" />
        <p class="mood-label">Adventure</p>
      </div>

      <div class="mood-group" style="--i: (1)" :class="{ active: activeMood == 1 }" @click="setActiveMood(1)" @mouseover="hoverMood('love-duck')">
        <img class="mood-duck-img" src="../../assets/images/ducks/love-duck.png" alt="love duck" />
        <p class="mood-label">Culture</p>
      </div>

      <div class="mood-group" style="--i: (2)" :class="{ active: activeMood == 2 }" @click="setActiveMood(2)" @mouseover="hoverMood('nervous-duck')">
        <img class="mood-duck-img" src="../../assets/images/ducks/nervous-duck.png" alt="nervous duck" />
        <p class="mood-label">Learning</p>
      </div>

      <div class="mood-group" style="--i: (3)" :class="{ active: activeMood == 3 }" @click="setActiveMood(3)" @mouseover="hoverMood('money-duck')">
        <img class="mood-duck-img" src="../../assets/images/ducks/money-duck.png" alt="money duck" />
        <p class="mood-label">Relaxing</p>
      </div>

      <div class="mood-group" style="--i: (4)" :class="{ active: activeMood == 4 }" @click="setActiveMood(4)" @mouseover="hoverMood('happy-duck')">
